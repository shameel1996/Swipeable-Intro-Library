...
abstract class OnSwipeListener(ctx: Context?) : OnTouchListener {
    private val gestureDetector: GestureDetector
    override fun onTouch(v: View?, event: MotionEvent?): Boolean {
        return gestureDetector.onTouchEvent(event)
    }

    open fun onSwipeRight() { // do nothing here
    }

    open fun onSwipeLeft() { // do nothing here
    }

    fun onSwipeTop() { // do nothing here
    }

    fun onSwipeBottom() { // do nothing here
    }
